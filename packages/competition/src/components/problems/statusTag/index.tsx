...
const StatusDescriptions = (status: number): [string, "ghost" | "success" | "error" | "warning" | "info" | undefined] => {
    switch (status) {
        case 0: return ['无效', "ghost"];
        case 1: return ['通过', "success"];
        case 2: return ['编译错误', "error"];
        case 3: return ['答案错误', "error"];
        case 4: return ['格式错误', "error"];
        case 5: return ['运行错误', "error"];
        case 6: return ['时间超限', "warning"];
